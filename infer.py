...
# Load the checkpoint
checkpoint = torch.load('checkpoint_final.pth', map_location=device)
...
for i in os.listdir("test/test/"):
    ...
    cv2.imwrite("test/predict_mask/{}".format(i), mask_rgb)
...
MASK_DIR_PATH = 'test/predict_mask' # change this to the path to your output mask folder
dir = MASK_DIR_PATH
res = mask2string(dir)
